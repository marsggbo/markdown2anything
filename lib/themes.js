...
const THEMES = [
  ...
  // ── 11. Claude Pro（更高级版 Claude 风格）─────────────────────────────────
  {
    ...
    css: `
      ...
      strong { font-weight: 700; color: #c2410c; }
      a { color: #b45309; text-decoration: underline; text-underline-offset: 3px; }
      h1 {
        font-size: 2em; font-weight: 800; color: #1c1917;
      ...
      h2 {
        font-size: 1.35em; font-weight: 700; color: #78350f;
        text-align: left; margin-top: 2.2em; margin-bottom: 0.8em;
        padding: 10px 16px;
      ...
      h3 {
        font-size: 1.15em; font-weight: 700; color: #92400e;
        margin-top: 1.8em; margin-bottom: 0.5em;
        display: flex; align-items: center; gap: 8px;
        font-family: system-ui, -apple-system, BlinkMacSystemFont, sans-serif;
      }
      h3::before {
        content: '◆'; color: #f59e0b; font-size: 0.7em; flex-shrink: 0;
      }
      h4, h5, h6 {
        font-size: 1em; font-weight: 700; color: #a16207;
        font-family: system-ui, -apple-system, BlinkMacSystemFont, sans-serif;
      }
      blockquote {
        border-left: none; margin: 1.8em 0;
        padding: 1em 1.4em 1em 1.6em; color: #78350f;
      ...
      blockquote::before {
        ...
        font-size: 3em; color: #fbbf24; opacity: 0.5; line-height: 1;
        font-family: Georgia, serif;
      }
      blockquote p { margin: 0; font-style: italic; }
      code {
        background: #fef3c7; padding: 2px 7px; border-radius: 5px;
        font-family: 'Cascadia Code', 'Fira Code', Consolas, monospace;
        font-size: 13.5px; color: #92400e;
        border: 1px solid #fde68a;
      }
      table { border-collapse: collapse; width: 100%; margin: 1.8em 0; border-radius: 10px; overflow: hidden; }
      table td, table th { border: none; border-bottom: 1px solid #fde68a; padding: 12px 16px; }
      table th { background: linear-gradient(90deg, #fef3c7, #fffbeb); font-weight: 700; color: #78350f; text-align: left; border-bottom: 2px solid #f59e0b; }
      table tr:nth-child(even) td { background: #fffbeb; }
      table tr:last-child td { border-bottom: none; }
      ul { padding-left: 0; list-style: none; }
      ul li { position: relative; padding-left: 1.6em; margin: 0.5em 0; }
      ul li::before { content: '▸'; position: absolute; left: 0; color: #f59e0b; font-weight: 700; }
      ol { padding-left: 1.8em; }
      ol li::marker { color: #f59e0b; font-weight: 700; }
      hr { border: none; height: 2px; background: linear-gradient(90deg, transparent, #f59e0b, transparent); margin: 2.5em 0; }
      figure { margin: 2em auto; text-align: center; }
      figcaption { display: block; text-align: center; color: #a16207; font-size: 13px; margin-top: 10px; font-style: italic; }
      p { margin: 1.1em 0; }
      img { border-radius: 10px; box-shadow: 0 4px 20px rgba(180,83,9,0.12); }
    `,
    wrapperBg: '#fffdf7',
  },
  ...
  // ── 12. Medium 编辑风格 ─────────────────────────────────────────────────
  {
    ...
    css: `
      ...
      a:hover { text-decoration: underline; }
      h1 {
        font-size: 2em; font-weight: 700; color: #1a1a1a;
        text-align: left; letter-spacing: -0.03em; margin: 0.5em 0 0.3em;
        font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;
        line-height: 1.25;
      }
      h2 {
        font-size: 1.4em; font-weight: 700; color: #1a1a1a;
        text-align: left; margin-top: 2em; margin-bottom: 0.4em;
      ...
      h4, h5, h6 { font-size: 1em; font-weight: 700; color: #555; font-family: 'Helvetica Neue', sans-serif; }
      blockquote {
        border-left: none; margin: 2em 0;
        padding: 0 0 0 28px; color: #6b6b6b;
        position: relative;
      ...
      table { border-collapse: collapse; width: 100%; margin: 1.5em 0; }
      table td, table th { border: none; border-bottom: 1px solid #e8e8e8; padding: 12px 16px; }
      table th { font-weight: 700; text-align: left; border-bottom: 2px solid #1a1a1a; font-family: 'Helvetica Neue', sans-serif; font-size: 14px; }
      ul, ol { padding-left: 1.8em; }
      hr { border: none; border-top: 1px solid #e8e8e8; margin: 2.5em 0; }
      figure { margin: 2.5em auto; text-align: center; }
      figcaption { display: block; text-align: center; color: #999; font-size: 14px; margin-top: 10px; font-style: italic; }
      p { margin: 1.1em 0; }
  ...
  // ── 13. 阮一峰博客（科技知性）────────────────────────────────────────────
  {
    ...
    css: `
      ...
      a { color: #0079c1; text-decoration: none; border-bottom: 1px solid rgba(0,121,193,0.3); }
      a:hover { border-bottom-color: #0079c1; }
      h1 {
        font-size: 1.6em; font-weight: bold; color: #000;
        text-align: left; border-bottom: 1px solid #e5e5e5;
        padding-bottom: 8px; margin: 1em 0 0.7em;
        font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;
      }
      h2 {
        font-size: 1.3em; font-weight: bold; color: #000;
        text-align: left; margin-top: 2em; padding: 0;
        border: none; border-bottom: 1px solid #e5e5e5; padding-bottom: 6px;
        font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;
      }
      h3 {
        font-size: 1.1em; font-weight: bold; color: #555;
        margin-top: 1.6em; border: none; padding: 0;
        font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;
      }
      h4, h5, h6 { font-size: 1em; font-weight: bold; color: #666; }
      blockquote {
        border-left: 4px solid #e0e0e0; margin: 1.5em 0;
        padding: 0.5em 1.2em; color: #777; background: #fafafa;
      }
      blockquote p { margin: 0; }
      code {
        background: #f7f7f7; padding: 2px 5px; border-radius: 3px;
        font-family: Menlo, Monaco, 'Courier New', monospace;
        font-size: 13px; color: #c7254e; border: 1px solid #e8e8e8;
      }
      table { border-collapse: collapse; width: 100%; margin: 1.5em 0; }
      ...
      figure { margin: 2em auto; text-align: center; }
      figcaption { display: block; text-align: center; color: #999; font-size: 13px; margin-top: 6px; }
      p { margin: 0.9em 0; }
      img { border-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); }
    `,
    wrapperBg: '#ffffff',
  },
  ...
  // ── 14. 简约蓝（清爽商务）────────────────────────────────────────────────
  {
    ...
    css: `
      ...
      strong { font-weight: 600; color: #2b6cb0; }
      a { color: #3182ce; text-decoration: none; }
      a:hover { text-decoration: underline; }
      h1 {
        font-size: 1.8em; font-weight: 700; color: #1a365d;
        text-align: left; margin: 0.5em 0 0.4em;
        padding-bottom: 10px;
        border-bottom: 3px solid #3182ce;
      }
      h2 {
        font-size: 1.3em; font-weight: 700; color: #2c5282;
        text-align: left; margin-top: 2em; margin-bottom: 0.6em;
        padding: 6px 14px;
      ...
      h3 {
        font-size: 1.1em; font-weight: 600; color: #2c5282;
        margin-top: 1.6em; margin-bottom: 0.4em;
        padding-left: 10px;
        border-left: 2px solid #90cdf4;
      }
      h4, h5, h6 { font-size: 1em; font-weight: 600; color: #4a5568; }
      blockquote {
        border-left: 3px solid #3182ce; margin: 1.5em 0;
        padding: 0.8em 1.2em; color: #4a5568;
        background: #ebf8ff; border-radius: 0 6px 6px 0;
      }
      blockquote p { margin: 0; }
      code {
        background: #ebf8ff; padding: 2px 6px; border-radius: 4px;
        font-family: 'Cascadia Code', 'Fira Code', Consolas, monospace;
        font-size: 13.5px; color: #2b6cb0; border: 1px solid #bee3f8;
      }
      table { border-collapse: collapse; width: 100%; margin: 1.5em 0; }
      table td, table th { border: 1px solid #bee3f8; padding: 10px 14px; }
      table th { background: #ebf8ff; font-weight: 700; color: #2c5282; text-align: left; }
      table tr:nth-child(even) td { background: #f0f9ff; }
      ul, ol { padding-left: 1.6em; }
      ul li::marker { color: #3182ce; }
      ol li::marker { color: #3182ce; font-weight: 600; }
      hr { border: none; border-top: 2px solid #bee3f8; margin: 2em 0; }
      figure { margin: 2em auto; text-align: center; }
      figcaption { display: block; text-align: center; color: #718096; font-size: 13px; margin-top: 8px; }
      p { margin: 1em 0; }
      img { border-radius: 6px; box-shadow: 0 2px 12px rgba(49,130,206,0.12); }
    `,
    wrapperBg: '#ffffff',
  },
];

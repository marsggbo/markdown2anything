  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .article-wrapper h2 {
      ...
      border-left: ${r(8)}px solid #ff2442; border-radius: 0 ${r(14)}px ${r(14)}px 0;
      background: #fff8f9; color: #1a1a1a; font-size: ${r(48)}px; line-height: 1.4;
    }
    .article-wrapper h3 {
      margin: 1.4em 0 .6em; padding-left: ${r(20)}px; border-left: ${r(6)}px solid #ffb3c1;
      color: #ff2442; font-size: ${r(42)}px; line-height: 1.45;
    }
    .article-wrapper h4, .article-wrapper h5, .article-wrapper h6 {
      margin: 1.2em 0 .5em; color: #333; font-size: ${r(38)}px;
    }
    .article-wrapper blockquote {
      margin: 1.4em 0; padding: ${r(28)}px ${r(32)}px; border: 2px solid #ffd6dc;
      border-radius: ${r(16)}px; background: #fff8f9; color: #555;
    }
    ...
    .article-wrapper td, .article-wrapper th { padding: ${r(16)}px ${r(20)}px; border: 2px solid #ffd6dc; }
    ...
    .article-wrapper code:not([class]) {
      padding: ${r(4)}px ${r(12)}px; border: 1px solid #ffb3c1; border-radius: ${r(8)}px;
      background: #fff0f2; color: #cc1f3c; font-size: ${r(34)}px;
    }
    ...
    .article-wrapper hr { height: ${r(4)}px; margin: 2em 0; border: none; background: #ffb3c1; }
